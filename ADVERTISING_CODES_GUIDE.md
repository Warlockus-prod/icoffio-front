...
- **Universal Format** `68f63437810d98e1a08f26de` - после контента статьи (UniversalAd)

#### **Компоненты:**
- ✅ **InlineAd** - для баннеров в контенте (728x90, 970x250)
- ✅ **SidebarAd** - для баннеров в сайдбаре (300x250, 300x600)
- ✅ **UniversalAd** - универсальный компонент для любых форматов (адаптивный)
...
### 2025-01-13 - РЕЛИЗ v1.4.0: НОВОЕ РЕКЛАМНОЕ МЕСТО
- ✅ **НОВЫЙ PlaceID** - добавлен `68f63437810d98e1a08f26de` для дополнительной монетизации
- ✅ **УНИВЕРСАЛЬНЫЙ КОМПОНЕНТ** - создан `UniversalAd.tsx` для гибкого размещения рекламы
- ✅ **РАЗМЕЩЕНИЕ** - добавлено после контента статьи для увеличения показов
- ✅ **ДОКУМЕНТАЦИЯ** - обновлены примеры использования и компоненты
- ✅ **АДАПТИВНОСТЬ** - поддержка любых размеров через кастомные стили
- ✅ **СОВМЕСТИМОСТЬ** - работает с существующими VOX скриптами
- ✅ **ВЕРСИЯ 1.4.0** - расширение рекламной системы
- ✅ **5 РЕКЛАМНЫХ МЕСТ** - максимальная монетизация статей без ущерба UX
