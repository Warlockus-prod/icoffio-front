...
1. **Проверьте PlaceID/ключи:** Должны быть корректными
2. **Проверьте домен:** Может быть не зарегистрирован в системе
3. **Проверьте geo-targeting:** Реклама может быть недоступна в регионе
4. **Проверьте content-policy:** Контент может не соответствовать политике
