...
- 💰 **[MONETIZATION_GUIDE.md](./MONETIZATION_GUIDE.md)** - Полное руководство по монетизации и доходности
- 📊 **[Текущая система](#текущие-рекламные-коды)** - Технические детали интеграции
...
### Использование компонентов рекламы в Next.js

#### InlineAd - для баннеров в контенте

```jsx
import { InlineAd } from "@/components/InlineAd";

// Leaderboard после заголовка
<InlineAd 
...
// Large Leaderboard в конце статьи
<InlineAd 
...
#### SidebarAd - для баннеров в сайдбаре

```jsx
import { SidebarAd } from "@/components/SidebarAd";

// Medium Rectangle сверху сайдбара
<SidebarAd 
  placeId="63da9e2a4d506e16acfd2a36" 
  format="300x250" 
/>

// Large Skyscraper снизу сайдбара
<SidebarAd 
...
### 2025-01-13 - РЕЛИЗ v1.4.0: МОБИЛЬНОЕ РЕКЛАМНОЕ МЕСТО
- ✅ **НОВЫЙ PlaceID** - добавлен `68f63437810d98e1a08f26de` для мобильной рекламы
- ✅ **МОБИЛЬНЫЙ КОМПОНЕНТ** - создан `MobileAd/UniversalAd.tsx` для формата 320x480
- ✅ **РАЗМЕЩЕНИЕ** - добавлено после контента статьи для мобильных пользователей
- ✅ **АДАПТИВНОСТЬ** - автоматическая адаптация под экраны (maxWidth: 100%)
- ✅ **МОБИЛЬНАЯ ОПТИМИЗАЦИЯ** - специально для смартфонов и планшетов
- ✅ **ДОКУМЕНТАЦИЯ** - обновлены примеры с правильным форматом 320x480
- ✅ **СОВМЕСТИМОСТЬ** - работает с существующими VOX скриптами
- ✅ **ВЕРСИЯ 1.4.0** - расширение мобильной рекламной системы
- ✅ **5 РЕКЛАМНЫХ МЕСТ** - включая мобильный формат для максимальной монетизации

### 2025-01-13 - ПАТЧ v1.4.1: ИСПРАВЛЕНИЕ РАЗМЕРОВ
- ✅ **ИСПРАВЛЕН РАЗМЕР** - уточнен формат 320x480 вместо "универсального"
- ✅ **КОМПОНЕНТ** - исправлен UniversalAd с правильными размерами для мобильной рекламы
- ✅ **ДОКУМЕНТАЦИЯ** - обновлена с корректным описанием мобильного формата
- ✅ **ТИПИЗАЦИЯ** - добавлена поддержка '320x480' | 'mobile' форматов
...
## 🎯 БЫСТРЫЙ СПРАВОЧНИК PlaceID

### **📋 Все рекламные места (8 мест):**

#### **Desktop форматы:**
```javascript
const DESKTOP_PLACES = {
  '728x90_leaderboard':     '63da9b577bc72f39bc3bfc68',  // После заголовка
  '300x250_rectangle':      '63da9e2a4d506e16acfd2a36',  // Сайдбар сверху
  '970x250_large_leader':   '63daa3c24d506e16acfd2a38',  // Конец статьи
  '300x600_large_sky':      '63daa2ea7bc72f39bc3bfc72',  // Сайдбар снизу  
  '160x600_wide_sky':       '68f6451d810d98e1a08f2725'   // Сайдбар средний
};
```
...
```javascript
const MOBILE_PLACES = {
  '320x50_mobile_banner':   '68f644dc70e7b26b58596f34',  // После заголовка
  '320x100_large_mobile':   '68f645bf810d98e1a08f272f',  // Середина контента
  '320x480_mobile_large':   '68f63437810d98e1a08f26de'   // После контента
};
```

#### **In-Image реклама:**
```javascript
const IN_IMAGE_PLACE = '63d93bb54d506e95f039e2e3';  // Поверх изображений
```

### **💰 Доходность (от высокой к низкой):**
1. `63da9e2a4d506e16acfd2a36` - 300x250 Medium Rectangle ⭐⭐⭐⭐⭐
2. `68f645bf810d98e1a08f272f` - 320x100 Large Mobile Banner ⭐⭐⭐⭐⭐  
3. `63da9b577bc72f39bc3bfc68` - 728x90 Leaderboard ⭐⭐⭐⭐
4. `68f644dc70e7b26b58596f34` - 320x50 Mobile Banner ⭐⭐⭐⭐
5. `63daa2ea7bc72f39bc3bfc72` - 300x600 Large Skyscraper ⭐⭐⭐
6. `63daa3c24d506e16acfd2a38` - 970x250 Large Leaderboard ⭐⭐⭐
7. `68f6451d810d98e1a08f2725` - 160x600 Wide Skyscraper ⭐⭐
8. `68f63437810d98e1a08f26de` - 320x480 Mobile Large ⭐⭐

### **🔗 Полезные ссылки:**
- 💰 **[MONETIZATION_GUIDE.md](./MONETIZATION_GUIDE.md)** - Полное руководство по монетизации
- 📊 **[GitHub Releases](https://github.com/Warlockus-prod/icoffio-front/releases)** - История версий
- 🎯 **[Live Site](https://app.icoffio.com)** - Действующий сайт
