...
// v10.19.0: pure helpers extracted to lib/telegram-simple/webhook-helpers.ts
// (unit-tested in __tests__/webhook-helpers.test.ts). Logic unchanged.
