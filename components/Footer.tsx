        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href={`/${locale}/leo-simulator`} className="text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-200 transition-colors">
                  {locale === 'pl' ? 'Symulator LEO' : 'LEO Simulator'}
                </Link>
              </li>
            </ul>
          </div>
