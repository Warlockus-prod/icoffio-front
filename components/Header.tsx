      ...
      <div className="mx-auto max-w-6xl px-4 h-14 flex items-center gap-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link
            ...
            title="Admin"
            className="p-2 rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-400 dark:text-neutral-600 hover:text-neutral-600 dark:hover:text-neutral-400 transition-colors"
          >
