...
## [8.6.6] - 2026-02-14 - 📱 Add Bottom Mobile Banner (320x50)

### 🎯 Что изменено
- ✅ В конец статьи добавлен мобильный формат `320x50` (`VOX_PLACES.MOBILE_BANNER`) перед video-slot
- ✅ Оставлена текущая логика: in-content mobile врезки + video-slot внизу
- ✅ Используется мягкий формат, чтобы не повторять проблему деформации крупного финального баннера
