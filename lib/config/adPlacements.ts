...
export const AD_PLACEMENTS: AdPlacementConfig[] = [
  ...
  // ==================== HOMEPAGE ====================
  {
    id: 'homepage-desktop-1',
    placeId: '63da9b577bc72f39bc3bfc68',
    format: '728x90',
    placement: 'inline',
    name: 'Homepage Leaderboard',
    description: '728x90 banner on homepage (Desktop)',
    location: 'homepage',
    position: 'content-top',
    enabled: true,
    priority: 8,
  ...
  },
  {
    ...
    description: '320x50 banner on homepage (Mobile)',
    location: 'homepage',
    position: 'content-top',
    enabled: true,
    priority: 8,
  ...
  // ==================== CATEGORY PAGES ====================
  {
    id: 'category-desktop-1',
    placeId: '63daa3c24d506e16acfd2a38',
    format: '970x250',
    placement: 'inline',
    name: 'Category Large Leaderboard',
    description: '970x250 banner on category pages (Desktop)',
    location: 'category',
    position: 'content-bottom',
    enabled: true,
    priority: 7,
  ...
  },
  {
    ...
    description: '320x100 banner on category pages (Mobile)',
    location: 'category',
    position: 'content-bottom',
    enabled: true,
    priority: 7,
