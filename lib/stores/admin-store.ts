...
interface AdminStore {
  ...
  // Current View
  activeTab: 'dashboard' | 'parser' | 'articles' | 'editor' | 'images' | 'queue' | 'settings' | 'logs' | 'advertising' | 'content-prompts' | 'activity' | 'telegram' | 'published-editor' | 'feedback' | 'ad-diagnostics' | 'info-portal';
